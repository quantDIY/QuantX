...
export function SignIn({ onSignIn, isLoading, error }: SignInProps) {
  ...
  return (
    <>
      {/* Theme toggle - Fixed positioning in top-right corner */}
      <Button
      variant="ghost"
      size="icon"
      onClick={toggleTheme}
            ...
            <CardContent className="[&amp;:last-child]:pb-6 space-y-8 px-10 pb-10" style={{ paddingTop: '2rem', paddingRight: '2rem', paddingBottom: '1rem', paddingLeft: '2rem' }}>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="inline-flex items-center space-x-3 py-2" style={{paddingBottom: '2.5rem'}}>
                  ...
                  disabled={isLoading}
                  className="h-5 w-5 border-2 rounded-md appearance-none flex items-center justify-center transition-colors" // Ensures consistent size and shape
                  style={{
                    minWidth: '1.25rem',
                    minHeight: '1.25rem',
                    width: '1.25rem',
