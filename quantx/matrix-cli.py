...
def pip_extras(install_all, uninstall_mode):
    ...
    pip_packages = [
        # === Python Wrappers (install after conda C++ libraries) ===
        {
            "name": "psycopg2 (Python)",
            "desc": "Python wrapper for PostgreSQL database (conda provides C++ lib).",
            "pip": "psycopg2-binary",
            "category": "Python Wrappers"
        },
        {
            "name": "pyzmq (Python)",
            "desc": "Python wrapper for ZeroMQ messaging (conda provides C++ lib).",
            "pip": "pyzmq",
            "category": "Python Wrappers"
        },
        {
            "name": "PyOpenGL (Python)",
            "desc": "Python wrapper for OpenGL graphics (conda provides C++ lib).",
            "pip": "pyopengl",
            "category": "Python Wrappers"
        },
        {
            "name": "cupy (Python)",
            "desc": "Python wrapper for CUDA GPU computing (conda provides C++ lib).",
            "pip": "cupy",
            "category": "Python Wrappers"
        },

        # === C++ Libraries NOT available on conda-forge ===
        {
            "name": "FastQuant (C++)",
            "desc": "High-performance quantitative analysis C++ library.",
            "pip": "fastquant",
            "category": "C++ Libraries"
        },

        # === Pure Python Packages NOT available on conda-forge ===
        {
            "name": "QF-Lib",
            "desc": "Quantitative finance library for backtesting and portfolio management.",
            "pip": "qflib",
        ...
        {
            "name": "vectorbt",
            "desc": "Next-gen Python library for quantitative analysis and backtesting.",
            "pip": "vectorbt",
            "category": "Quantitative Finance"
        },
        {
            "name": "gym",
            "desc": "OpenAI Gym for developing reinforcement learning algorithms.",
            "pip": "gym",
        ...
        {
            "name": "pyoo",
            "desc": "Python bridge for LibreOffice & OpenOffice.",
            "pip": "pyoo",
            "category": "Productivity"
        }
    ]
